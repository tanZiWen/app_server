    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold ">智能云硬件</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                     ...
                     <li>
                        <a class="J_menuItem" href="Register_test.html">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#">
                            ...
                            <span style="font-size:16px;" class="nav-label">设备管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="${ctx}/web/deviceListSkip">设备浏览</a>
                            </li>
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="product_list.html">产品管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="active_list.html">动作管理</a>
                            </li>
                        </ul>
                    </li>
                     <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span style="font-size:16px;" class="nav-label">计划管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="schedul_list.html">定时任务</a>
                            </li>
                        </ul>
                    </li>
                      <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span style="font-size:16px;" class="nav-label">设备运维</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="alarm_list.html">报警中心</a>
                            </li>
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="operation_list.html">运维管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="log_management.html">日志管理</a>
                            </li>
                        </ul>
                    </li>
                    <!--志勇start  -->
                     <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span style="font-size:16px;" class="nav-label">基本信息</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <!-- <li>
                                <a class="J_menuItem" style="font-size:14px;" href="UseInfo.html">基本信息</a>
                            </li> -->
                             <li>
                                 <a class="J_menuItem" style="font-size:14px;" href="UserInfo.html">基本信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" style="font-size:14px;" href="customer_information.html">客户信息</a>
                            </li>
							 <li>
                                <a class="J_menuItem" style="font-size:14px;" href="Contact.html">联系人</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-alerts">
								...
								<li>
                                    <a class="J_menuItem" href="UserInfo.html">
                                        <div>
                                            <span class="glyphicon glyphicon-user" aria-hidden="true"></span> 基本信息     
                                        </div>
                                    </a>
                                </li>
                                <li class="divider"></li>
                                <li>
                                    <a class="J_menuItem" href="customer_information.html">
                                        <div>
                                            <i class="fa fa-users"></i>  客户信息                         
                                        </div>
                                    </a>
                                </li>								
                                <li class="divider"></li>
								<li>
                                    <a class="J_menuItem" href="Contact.html">
                                        <div>
                                 ...
                                 <li class="divider"></li>
								<li>
                                    <a class="J_menuItem" href="${ctx }/exit">
                                        <div>
            ...
            <div class="row J_mainContent" id="content-main">
				...
				src="${ctx}/web/map" frameborder="0" data-id="index_v1.html" seamless></iframe>
			</div>
		</div>
		<!--右侧部分结束-->
	</div>
